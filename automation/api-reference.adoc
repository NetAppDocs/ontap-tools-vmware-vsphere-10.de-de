...
.Schritte
. Geben Sie die folgende URL in Ihren Browser ein, ersetzen Sie dabei die Variable durch die entsprechende IP-Adresse und Portkombination und drücken Sie *Enter*.
+
`\https://$FQDN_IP_PORT/`
