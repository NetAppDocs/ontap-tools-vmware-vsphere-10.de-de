...
summary: Wenn Sie in der vCenter-Objektansicht mit der rechten Maustaste auf das Datastore-Objekt klicken, werden ONTAP-Tools für von VMware vSphere unterstützte Aktionen im Abschnitt Plug-in angezeigt. 
---
...
[role="lead"]
Wenn Sie in der vCenter-Objektansicht mit der rechten Maustaste auf das Datastore-Objekt klicken, werden ONTAP-Tools für von VMware vSphere unterstützte Aktionen im Abschnitt Plug-in angezeigt. Bestimmte Aktionen werden abhängig vom Typ des Datenspeichers und den aktuellen Benutzerberechtigungen aktiviert.
