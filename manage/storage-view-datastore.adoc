...
summary: Die ONTAP-Speicheransicht unter der Registerkarte „Konfigurieren“ der ONTAP tools for VMware vSphere liefert Daten zum Datenspeicher und seinen Volumes. 
---
