...
sidebar: sidebar 
keywords:  
summary: 'Sie können optionale Dienste wie VASA Provider, den Import der vVols-Konfiguration und Disaster Recovery (SRA) mit dem ONTAP tools Manager aktivieren.' 
---
...
. Im Abschnitt *Services* können Sie bei Bedarf optionale Dienste wie VASA Provider, den Import der vVols -Konfiguration und Disaster Recovery (SRA) aktivieren.
+
