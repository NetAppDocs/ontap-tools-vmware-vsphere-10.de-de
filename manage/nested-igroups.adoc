...
Ab ONTAP tools für VMware vSphere 10.4 erstellt und verwaltet ONTAP tools automatisch ONTAP- und vCenter-Objekte, was die Verwaltung von Datenspeichern in VMware-Rechenzentrumsumgebungen vereinfacht.
...
NOTE: Nur benutzerdefinierte igroups können wiederverwendet werden. Igroups, die während der Migration von ONTAP tools 9.x erstellt wurden (migrierte igroups), können nicht wiederverwendet werden und werden ab ONTAP tools 10.5P2 automatisch gelöscht, sobald sie nicht mehr verwendet werden.
