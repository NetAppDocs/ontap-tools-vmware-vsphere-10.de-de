...
+
Auf dieser Seite können Sie geschützte Hostcluster, den Schutzstatus, die SnapMirror Beziehung und den Status überwachen. Wählen Sie Konsistenzgruppen aus, um Kapazität, zugehörige Datenspeicher und untergeordnete Gruppen anzuzeigen.
