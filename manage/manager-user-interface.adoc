...
* Jobs überwachen – Überwachen und debuggen Sie asynchrone Jobs, die sowohl über die ONTAP tools Plug-in-Oberfläche als auch die ONTAP tools Manager-Oberfläche gestartet wurden. Sie können Jobs nach Zeitraum filtern, die Seitengröße anpassen und Jobdetails, einschließlich Fehlern und Unteraufgaben, anzeigen. Klicken Sie auf den Fehlerstatus, um die Fehlerdetails anzuzeigen. Bei Jobs mit Unteraufgaben erweitern Sie die Zeile, um Beschreibungen und Status anzuzeigen. Verwenden Sie für Unterjobs die Drilldown-Funktion des Jobs, um die Details anzuzeigen.
