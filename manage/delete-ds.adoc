...
summary: Die Aktion „Datenspeicher löschen“ entfernt den Datenspeicher. Bei einem NFS- oder VMFS-Datenspeicher wird ein Dialogfeld mit der Liste der VMs angezeigt, die diesen Datenspeicher verwenden. 
---
...
* Wenn die Initiatorgruppe nicht verwendet wird, werden ihre Initiatoren aus der Initiatorgruppe entfernt.
