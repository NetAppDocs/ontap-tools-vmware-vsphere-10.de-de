...
Ab ONTAP tools 10.5P2 werden migrierte Initiatorgruppen gelöscht, sobald sie nicht mehr verwendet werden. In früheren Versionen wurden migrierte Initiatorgruppen nie entfernt. Beachten Sie Folgendes:

* Migrierte igroups können nicht in mehreren Datastores wiederverwendet werden.
* Benutzerdefinierte igroups (benutzerdefiniert) werden niemals gelöscht und können weiterhin wiederverwendet werden.
