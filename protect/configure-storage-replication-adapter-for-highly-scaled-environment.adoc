...
NOTE: Das angegebene Zeitüberschreitungsintervall ist der Maximalwert. Sie müssen nicht warten, bis die maximale Zeitüberschreitung erreicht ist. Die meisten Befehle werden innerhalb des festgelegten maximalen Zeitüberschreitungsintervalls abgeschlossen.
