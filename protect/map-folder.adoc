...
.Ergebnis
Auf der Seite „Ordnerzuordnungen“ werden die geschützten Site-Ressourcen und die Ressourcen der Wiederherstellungssite angezeigt. Sie können die gleichen Schritte für andere Ordner in Ihrer Umgebung ausführen.
