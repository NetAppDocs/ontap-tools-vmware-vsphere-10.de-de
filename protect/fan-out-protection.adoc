...
. Fügen Sie Datenspeicher zum Hostclusterschutz hinzu, indem Sie link:../manage/edit-hostcluster-protection.html["Geschütztes Host-Cluster ändern"] folgen. Fügen Sie sowohl asynchrone als auch synchrone Richtlinientypen hinzu.
