...
NOTE: Wenn Sie ein Storage-Back-End mithilfe der vSphere Client-UI hinzufügen, unterstützt der VVols-Datastore das direkte Hinzufügen eines SVM-Benutzers nicht.
