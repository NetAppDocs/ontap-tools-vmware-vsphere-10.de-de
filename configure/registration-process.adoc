...
. Geben Sie einen Namen und die Zugangsdaten für den VASA Provider ein. Der Benutzername darf nur Buchstaben, Zahlen und Unterstriche enthalten. Das Passwort muss zwischen 8 und 256 Zeichen lang sein.
