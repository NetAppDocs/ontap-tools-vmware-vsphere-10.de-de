...
====
Um die HA-Funktion nutzen zu können, stellen Sie sicher, dass CPU Hot-Add und Memory Hot-Plug während der Bereitstellung oder in den VM-Einstellungen aktiviert sind.
