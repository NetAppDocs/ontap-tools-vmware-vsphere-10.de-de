...
NOTE: Eine Migration von ONTAP-Tools für VMware vSphere 9.XX ist nur bei Verwendung von VASA Provider und VVols erforderlich. Die NFS- und VMFS-Datastores werden während der Speichererkennung erkannt.


NOTE: Nach der Migration von ONTAP Tools für VMware vSphere 9.x zu 10.4 werden VVols-Datastores mit NVMe/FC-Protokoll nicht mehr in Betrieb, da die ONTAP Tools 10.4 das NVMe-of-Protokoll nur mit VMFS-Datastores unterstützt.
