...
. Fügen Sie dem vCenter-Server und ONTAP-Tools für VMware vSphere Storage Provider 10.1 hinzu link:../configure/registration-process.html["Registrieren Sie VASA Provider auf vCenter Server"].
...
+
Sobald der alte VASA-Provider angehalten wurde, erfolgt ein Failover von vCenter Server zu ONTAP-Tools für VMware vSphere 10.1. Der Zugriff auf alle Datenspeicher und VMs erfolgt über ONTAP Tools für VMware vSphere 10.1.
