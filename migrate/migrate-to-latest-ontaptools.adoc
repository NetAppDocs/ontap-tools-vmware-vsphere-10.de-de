...
NOTE: Es wird empfohlen, ONTAP-Tools für das Setup von VMware vSphere 9.xx nur zu migrieren, wenn das Setup die Funktion VASA Provider allein bedient.


NOTE: Nach der Migration von ONTAP-Tools für VMware vSpher 9.x zu 10.3 funktionieren VVols-Datastores mit dem NVMe/FC-Protokoll nicht, da die ONTAP-Tools 10.3 nur NVMe-of mit VMFS-Datastores unterstützt.

*Über diese Aufgabe*

Die Migration wird von ONTAP-Tools für VMware vSphere 9.12D1- und 9.13D2-Versionen bis Version 10.3 unterstützt.
...
.. Klicken Sie auf das Auslassungsmenü und dann auf *Konfiguration zurücksetzen*
...
+
Sobald der alte VASA Provider angehalten wurde, erfolgt ein Failover von vCenter Server zu den ONTAP Tools für VMware vSphere. Der Zugriff auf alle Datenspeicher und VMs erfolgt über ONTAP Tools für VMware vSphere.
...
Nachdem Sie von alten Versionen von ONTAP-Tools für VMware vSphere auf Version 10.3 migriert haben, können Sie die SRA-Adapter erneut scannen, um zu überprüfen, ob die Details auf der Seite VMware Live Site Recovery Storage Replication Adapters aktualisiert werden.
