...
sidebar: sidebar 
keywords: upgrade 
summary: Beim Upgrade von ONTAP Tools für VMware vSphere 10.0 und 10.1 auf 10.2 wird ein Recovery-Volume erstellt und alle erforderlichen Details in das Recovery-Volume übernommen. 
---
