...
** Durchsuchen Sie über die Benutzeroberfläche von ONTAP System Manager das Volume anhand des Namens in der Suchleiste, und öffnen Sie dann das Volume, indem Sie den Namen auswählen. Wechseln Sie zu Snapshot und fügen Sie den Snapshot dieses Volumes hinzu.
...
* Gehen Sie auf die Registerkarte Snapshots und wählen Sie die Schaltfläche *Snapshot erstellen*. Erstellen Sie einen stillgelegten Snapshot der VM. Weitere Informationen finden Sie unter https://docs.vmware.com/en/VMware-vSphere/7.0/com.vmware.vsphere.vm_admin.doc/GUID-9720B104-9875-4C2C-A878-F1C351A4F3D8.html["Erstellen Sie einen Snapshot einer virtuellen Maschine"^].
