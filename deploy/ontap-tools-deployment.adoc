...
[role="lead"]
Die ONTAP Tools für die VMware vSphere Appliance werden als kleiner Single Node mit Kernservices zur Unterstützung von NFS und VMFS Datastores implementiert. Die Implementierung von ONTAP Tools kann bis zu 45 Minuten dauern.
