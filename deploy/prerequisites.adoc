...
| 443 (TCP) | Dies ist der Pass-Through-Port für die eingehende Kommunikation für den VASA-Provider-Service. Auf diesem Port werden selbstsigniertes VASA-Provider-Zertifikat und ein benutzerdefiniertes CA-Zertifikat gehostet. 
